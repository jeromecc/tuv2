...
// Contient l'affichage généré par la classe.
    ...
    */
	...
	$message .= "Concerne le patient : ".$this->patient->getSexe ( )." ".$this->patient->getPrenom ( )." ".
	    strtoupper ( $this->patient->getNom ( ) )." (".$duree->getAge ( $age -> getTimestamp ( ) ).")".$retourLigne ;
	...
	else $message .= "Admis aux urgences le : --".$retourLigne ;
	...
	else $message .= "Heure Examen : --".$retourLigne ;
