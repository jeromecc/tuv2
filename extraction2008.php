...
$export = new clExport2008();
$contenu1 = $export->genAffichage ( new clDate('2008-01-01 00:00:00'), new clDate('2008-01-31 23:59:59')) ;
...
$contenu2 = $export->genAffichage ( new clDate('2008-02-01 00:00:00'), new clDate('2008-02-29 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu3 = $export->genAffichage ( new clDate('2008-03-01 00:00:00'), new clDate('2008-03-31 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu4 = $export->genAffichage ( new clDate('2008-04-01 00:00:00'), new clDate('2008-04-30 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu5 = $export->genAffichage ( new clDate('2008-05-01 00:00:00'), new clDate('2008-05-31 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu6 = $export->genAffichage ( new clDate('2008-06-01 00:00:00'), new clDate('2008-06-30 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu7 = $export->genAffichage ( new clDate('2008-07-01 00:00:00'), new clDate('2008-07-31 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu8 = $export->genAffichage ( new clDate('2008-08-01 00:00:00'), new clDate('2008-08-31 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu9 = $export->genAffichage ( new clDate('2008-09-01 00:00:00'), new clDate('2008-09-30 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu10 = $export->genAffichage ( new clDate('2008-10-01 00:00:00'), new clDate('2008-10-31 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu11 = $export->genAffichage ( new clDate('2008-11-01 00:00:00'), new clDate('2008-11-30 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu12 = $export->genAffichage ( new clDate('2008-12-01 00:00:00'), new clDate('2008-12-31 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
