<?php
createItem($formx2,$etape,$formulaireAEV["id_instance"][$i].'AEV_Libelle'.$i,'<span style="color:#CC3333;font-weight:bold;">*** DOSSIER ***</span>','TXT','<span style="color:#CC3333;font-weight:bold;">Expositions sexuelles Risque important Source inconnue</span>');
