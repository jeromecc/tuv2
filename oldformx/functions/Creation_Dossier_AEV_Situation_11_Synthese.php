<?php
createItem($formx2,$etape,$formulaireAEV["id_instance"][$i].'AEV_Libelle'.$i,'<span style="color:#CC3333;font-weight:bold;">*** DOSSIER ***</span>','TXT','<span style="color:#CC3333;font-weight:bold;">Exposition au sang Risque intermédiaire Source VHC</span>');
