...
$export = new clExport2009();
$contenu1 = $export->genAffichage ( new clDate('2009-01-01 00:00:00'), new clDate('2009-01-31 23:59:59')) ;
...
$contenu2 = $export->genAffichage ( new clDate('2009-02-01 00:00:00'), new clDate('2009-02-29 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu3 = $export->genAffichage ( new clDate('2009-03-01 00:00:00'), new clDate('2009-03-31 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu4 = $export->genAffichage ( new clDate('2009-04-01 00:00:00'), new clDate('2009-04-30 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu5 = $export->genAffichage ( new clDate('2009-05-01 00:00:00'), new clDate('2009-05-31 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu6 = $export->genAffichage ( new clDate('2009-06-01 00:00:00'), new clDate('2009-06-30 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu7 = $export->genAffichage ( new clDate('2009-07-01 00:00:00'), new clDate('2009-07-31 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu8 = $export->genAffichage ( new clDate('2009-08-01 00:00:00'), new clDate('2009-08-31 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu9 = $export->genAffichage ( new clDate('2009-09-01 00:00:00'), new clDate('2009-09-30 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu10 = $export->genAffichage ( new clDate('2009-10-01 00:00:00'), new clDate('2009-10-31 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu11 = $export->genAffichage ( new clDate('2009-11-01 00:00:00'), new clDate('2009-11-30 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
...
$contenu12 = $export->genAffichage ( new clDate('2009-12-01 00:00:00'), new clDate('2009-12-31 23:59:59')) ;
if ( $options->getOption ( 'CCAMExterne' ) ) 
{
