...
/* Titre  : Classe ListeRestreinte
	...
	Ajouts apportés au code : 
  Auteur : Francois Derock <fderock@ch-hyeres.fr>
  
  Pouvoir indiquer si un acte NGAP est envoyé ou pas à la facturation.
	Date   : Juillet 2007
	
  Restreint la modification de libellé pour certains actes NGAP
  Date   : Octobre 2007
*/
class clCCAMlisteRestreinte{
...
if ($paramForm[libActe]=="Consultation urgentiste non facturable" ||
    $paramForm[libActe]=="Consultation urgentiste" ||
    $paramForm[libActe]=="Consultation urgentiste spécialiste non facturable" ||
    $paramForm[libActe]=="Consultation urgentiste spécialiste" ||
    $paramForm[libActe]=="Consultation sage-femme" ||
    $paramForm[libActe]=="Consultation sage-femme non facturable" ||
    $paramForm[libActe]=="Consultation gynécologie et obstétrique" ||
    $paramForm[libActe]=="Consultation gynécologie et obstétrique non facturable" ||
    $paramForm[libActe]=="MTU" ||
    $paramForm[libActe]=="ATU"
    ) {
