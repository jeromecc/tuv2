<?php
createItem($formx2,$etape,$formulaireAEV["id_instance"][$i].'AEV_Libelle'.$i,'<span style="color:#CC3333;font-weight:bold;">*** DOSSIER ***</span>','TXT','<span style="color:#CC3333;font-weight:bold;">Exposition au sang Risque important Source VIH et VHC</span>');
...
if ( $tabValeurstemp['AEV_Document_Note'] != " " ) createItem($formx2,$etape,$formulaireAEV["id_instance"][$i].'AEV_Document_Note'.$i,'','TXT','Note d &#146;information à la victime');
...
if ( $tabValeurstemp['AEV_Date_Prophylaxie'] != " " ) createItem($formx2,$etape,$formulaireAEV["id_instance"][$i].'AEV_Date_Prophylaxie'.$i,'<span style="color:green;">Date de la première prise de la prophylaxie</span>','TXT',$tabValeurstemp['AEV_Date_Prophylaxie']);

if ( $tabValeurstemp['AEV_Heure_Prophylaxie'] != " " ) createItem($formx2,$etape,$formulaireAEV["id_instance"][$i].'AEV_Heure_Prophylaxie'.$i,'<span style="color:green;">Heure de la première prise de la prophylaxie</span>','TXT',$tabValeurstemp['AEV_Heure_Prophylaxie']);
...
if ( $tabValeurstemp['AEV_Message_Travail'] != " " && $tabValeurstemp['AEV_Accident_Travail'] == "Oui" ) createItem($formx2,$etape,$formulaireAEV["id_instance"][$i].'AEV_Message_Travail'.$i,'','TXT','Déclaration accident de travail');

if ( $tabValeurstemp['AEV_Message_Certificat'] != " " && $tabValeurstemp['AEV_Accident_Travail'] == "Oui" ) createItem($formx2,$etape,$formulaireAEV["id_instance"][$i].'AEV_Message_Certificat'.$i,'','TXT','Remplissage du certificat médical initial');
