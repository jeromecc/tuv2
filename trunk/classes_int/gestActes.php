 ...
 * Dans collecteur actes aucune option ou methode xham ne doit apparaitre
 * ( principe de découplage du code selon maitre Potentier )
 * 
 */
 ...
 class gestActes 
 {
 	...
 	public function __construct($opt='')
 	{
		...
		//inclusion des classes noyau (requetes)
		//rien à faire: natif xham
 		...
 		//appel du controleur
 		try
 		$tabRetourCaController = caController::executeAction($xham->getNavi(0),$xham->getNavi(1));
 		$this->af = $tabRetourCaController['af'];
 	...
 	public static function setEnvironnement() 
 	{
 		...
 		caEnvironnementBase::setInfoConnexion('default','mysql',MYSQL_HOST,MYSQL_USER,MYSQL_PASS,CCAM_BDD);
